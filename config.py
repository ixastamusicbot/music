...
# Set a valid YT proxy URL here
YTPROXY_URL = getenv("YTPROXY_URL", "https://yt.lemnoslife.com")  # Public YT proxy
...
CACHE_DURATION = int(getenv("CACHE_DURATION", "86400"))  # 24 hours
CACHE_SLEEP = int(getenv("CACHE_SLEEP", "3600"))        # 1 hour
